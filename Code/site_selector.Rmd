...
# Sample Standards and Exceedance Summary
...
**AJ's TABLE TODO**
Analyte	STD	max_value (mg_L)
TP	cdphe - cold	0.11
TP	cdphe - warm	0.17
NO3	epa-drinking	0.1
ph	cdphe-warm	9
ph	epa-drinking	8.5
...
create_facet_bar_plot_annual <- function(df, output_dir, file_name, x_axis_var, stratify_by_method = FALSE) {
  tryCatch({
    ...
    df <- df %>%
      dplyr::mutate(
        analyte_name_for_plot = dplyr::if_else(!is.na(analyte.abbr) & analyte.abbr != "",
                                              analyte.abbr, analyte),
    ...
    p <- p +
      ...
      labs(
        title = ifelse(stratify_by_method,
